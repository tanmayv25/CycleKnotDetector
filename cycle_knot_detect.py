...
PatternExpr_254 = da.pat.TuplePattern([da.pat.ConstantPattern('Terminate')])
PatternExpr_259 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('Terminate')])])
_config_object = {}
import sys
import graph_config
...
class P(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_0', PatternExpr_206, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_205]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_1', PatternExpr_254, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, ps, successors, own_id, **rest_335):
        super().setup(ps=ps, successors=successors, own_id=own_id, **rest_335)
        self._state.ps = ps
    ...
    def run(self):
        ...
        while (_st_label_251 == 0):
            _st_label_251 += 1
            if PatternExpr_259.match_iter(self._PReceivedEvent_1, SELF_ID=self._id):
                _st_label_251 += 1
            else:
